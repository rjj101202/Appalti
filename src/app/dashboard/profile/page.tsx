            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '1.5rem' }}>
                <div style={{
                  ...
                  height: 80,
                  borderRadius: '50%',
                  backgroundColor: avatar ? 'transparent' : '#9333ea',
              ...
              <div className="card">
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                  <div style={{ textAlign: 'center', padding: '1rem', backgroundColor: '#f3e8ff', borderRadius: 8 }}>
                    <div style={{ fontSize: '2em', fontWeight: '700', color: '#9333ea' }}>{stats.activeBids || 0}</div>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: 8,
                          borderLeftWidth: 4,
                          borderLeftColor: isUrgent ? '#dc2626' : isWarning ? '#f59e0b' : '#9333ea',
